  ...
  container.innerHTML = `
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-gray-600 dark:text-gray-300">
        ...
        <div class="space-y-2">
          <p><span class="font-semibold text-gray-900 dark:text-white">4.</span> <strong>Alternatives:</strong> use OpenAI/OpenRouter via "Call AI API directly" (bring your own key), or click <strong>Assemble Prompt</strong> to copy the prompt into any chat LLM. No server? Paste transcript and comments manually — everything still works.</p>
